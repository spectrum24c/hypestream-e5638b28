<header 
  className={cn(
    "fixed top-0 left-0 w-full z-40 transition-all duration-300 backdrop-blur-[6px]",
    isScrolled 
      ? "bg-[rgba(0,0,0,0.7)] shadow-lg py-2" 
      : "bg-gradient-to-b from-[rgba(0,0,0,0.7)] to-transparent py-3"
  )}
>
