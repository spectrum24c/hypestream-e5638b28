...
const MobileNavigation: React.FC<MobileNavigationProps> = ({
  ...
  return (
    <>
      {/* Menu Toggle Button */}
      <button
        className="md:hidden p-2 text-white bg-hype-purple rounded fixed top-4 right-4 z-50"
      ...
      {menuOpen && (
        <div className="fixed inset-0 bg-hype-dark text-white z-40 overflow-y-auto">
...
export default MobileNavigation;import React, { useState } from 'react';
import { Link } from 'react-router-dom';
import { LogOut, Trash2, X, Menu } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { categories } from '@/data/categories';
